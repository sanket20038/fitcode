...
const glutesContent = [
  {
    ...
    images: [
      { src: "/musclewiki/Images/male-barbell-hip-thrust-front.gif", alt: "Hip Thrust Front" },
      { src: "/musclewiki/Images/male-barbell-hip-thrust-side.gif", alt: "Hip Thrust Side" }
    ],
    steps: [
  ...
  },
  {
    ...
    difficulty: "Beginner",
    images: [
      { src: "/musclewiki/Images/male-bodyweight-glute-bridge-front.gif", alt: "Glute Bridge Front" },
      { src: "/musclewiki/Images/male-bodyweight-glute-bridge-side.gif", alt: "Glute Bridge Side" }
    ],
    steps: [
