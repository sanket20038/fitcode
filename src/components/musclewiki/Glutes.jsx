...
const glutesIntro = {
  intro: "The glutes are essential for hip power, posture, and lower body strength. Training your glutes improves athletic performance, injury prevention, and daily movement.",
  warmup: [
    "5 minutes of light cardio (e.g., brisk walking, bodyweight squats)",
    "Dynamic stretches: hip circles, glute bridges, gentle lunges"
  ],
  cooldown: [
    "Gentle glute and hip stretching",
...
const Glutes = () => {
  ...
  const handleTranslate = async () => {
    ...
    try {
      ...
      const [intro, ...warmup] = await Promise.all([
        ...
        ...glutesIntro.warmup.map((item) => translateText(item, translateLanguage))
      ]);
  ...
  const contentToRender = translateEnabled ? translatedContent : glutesContent;
  const introToRender = translateEnabled && translatedIntro ? translatedIntro : glutesIntro;
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-gray-800">
      ...
      <main className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="mb-8 p-6 bg-white/10 rounded-2xl border border-white/10 shadow-lg animate-fade-in">
          <h2 className="text-2xl font-bold text-white mb-2">Why Train Your Glutes?</h2>
        ...
        <div className="flex items-center gap-3 mb-10 animate-fade-in">
          ...
          <h1 className="text-5xl font-black text-transparent bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text drop-shadow-lg">
            {translateEnabled ? translatedLabels.glutes : "Glutes"}
          </h1>
        </div>
        {/* Exercise Sections */}
