    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-gray-800">
      ...
      <main className="max-w-3xl mx-auto px-4 py-8">
        <div className="bg-white/5 border-white/10 backdrop-blur-xl shadow-xl rounded-2xl p-8">
          <h1 className="text-4xl font-black text-white mb-6 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">Forearms</h1>
          {/* Wrist Curl */}
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-white mb-2">Wrist Curl</h2>
            <p className="text-white/80 mb-2"><strong>Difficulty</strong>: Beginner</p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <img className="w-full rounded-xl" src="/musclewiki/Images/barbell-wristcurl-male-front.gif" alt="Wrist Curl Front" />
              <img className="w-full rounded-xl" src="/musclewiki/Images/barbell-wristcurl-male-side.gif" alt="Wrist Curl Side" />
            </div>
            <ol className="list-decimal list-inside text-white/90 space-y-2">
              <li>Sit on a bench with your forearms resting on your thighs, holding a barbell with an underhand grip.</li>
