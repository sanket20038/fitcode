...
const trapsMidBackContent = [
  {
    ...
    video: "https://youtu.be/2OJOOmX6Wuw?si=psEIUtt0A03VUkyq",
    instructions: [
      "Hold a barbell with an overhand grip, bend at the hips until torso is ~45°.",
      "Row the bar into your lower chest, squeezing shoulder blades together.",
      "Lower with control and repeat."
    ],
    safetyTips: [
      "Keep your back flat and core braced to protect your spine.",
      "Avoid jerking the weight or using momentum."
    ],
    proTips: [
      "Use a slightly underhand grip if you want more lat activation; overhand hits more upper back."
    ]
  },
  {
    title: "💪 Lever T-Bar Row",
    video: "https://youtu.be/AleqQsqjyCg?si=TwQRd1AqQKfGwEvi",
    instructions: [
      "Stand over a T-bar row machine and grab the handles.",
      "With a flat back, pull the handles to your chest, elbows tucked.",
      "Slowly return to the starting position and repeat."
    ],
    safetyTips: [
      "Don't round your lower back — keep a strong hinge and controlled pull.",
      "Avoid bouncing at the bottom — this strains your spine."
    ],
    proTips: [
      "Try narrow grip for mid back, and wide grip to shift focus to upper back and rear delts."
    ]
  }
];
...
const TrapsMidBack = () => {
  ...
  const handleTranslate = async () => {
    if (translateEnabled) {
      ...
      setTranslatedLabels({ trapsMidBack: "Traps & Mid Back" });
    ...
    try {
      ...
      const trapsMidBackLabel = await translateText("Traps & Mid Back", translateLanguage);
      setTranslatedLabels({ trapsMidBack: trapsMidBackLabel });
      ...
      <main className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-3 mb-10 animate-fade-in">
          ...
          <h1 className="text-5xl font-black text-transparent bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text drop-shadow-lg">
            {translateEnabled ? translatedLabels.trapsMidBack : "Traps & Mid Back"}
          </h1>
        </div>
        {/* Exercise Sections */}
